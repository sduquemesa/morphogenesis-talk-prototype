...
| 1:38–2:25 | Collective throb | Every phone converges on a gently pulsing drone, with slightly different rates. |
| 2:25–3:00 | Dissolution | The drone recedes; short, soft, resonant noise bursts form a swarm that thins into silence. |
...
The harmonic collection remains C Lydian dominant, weighted toward C, E, F#, G, and Bb. Pitches are kept mainly between 220 and 523 Hz. A gentle high-pass near 175 Hz and low-pass near 2.25 kHz reduce inaudible bass and potentially tiring highs. The final noise passes through a broad band-pass resonator at approximately 590–920 Hz. Per-phone levels are conservative; nevertheless, begin the room test at low media volume and increase gradually.
