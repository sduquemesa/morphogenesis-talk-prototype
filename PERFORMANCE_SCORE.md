...
Touching and moving across the field steers it audibly without taking over the score. Horizontal position sweeps the tone color and noise resonance and bends the assigned pitch by at most seven cents. Vertical position changes event spacing, tonal emphasis, noise resonance, and the depth of the drone swell. A small luminous point follows the touch and fades after release. The audio steering eases back toward neutral; touch never changes the assigned note, role, movement, or total duration.
